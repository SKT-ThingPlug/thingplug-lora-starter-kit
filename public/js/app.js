...
jQuery(document).ready(function() {
  ...
  var nodeID = ['12345678901234567890sjw6', '12345678901234567890sjw7'];  
  
  var numofDevice = nodeID.length;
...
for (var i =0; i < numofDevice; i++) {	
    ...
    // .exit()
    // .remove(); 
	//d3.selectAll("svg > *").empty();
	//d3.selectAll('svg > *').html('');
//d3.selectAll("svg > *").clear();
